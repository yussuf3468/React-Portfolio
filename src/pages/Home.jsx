...
import Abdiaziz from '../assets/images/Abdiaziz3.jpg';
import Default from '../assets/images/defaultPic.jpg';
...
const HomePage = ({ darkMode }) => {
  ...
  return (
    <div ref={containerRef} className={`min-h-screen transition-all duration-500 ${darkMode ? 'dark' : ''}`}>
      ...
      {/* Call to Action */}
      <section className="py-16 text-center bg-gray-150 dark:bg-gray-800">
