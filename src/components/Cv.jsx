  ...
  const cvData = {
    ...
    education: [
      ...
      },
      {
        ...
        degree:
          "Professional Diploma in Information Technology (Completed Two Semesters)",
        period: "2023 - 2024",
      },
      {
        institution: "IGCSE",
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "A real estate website showcasing property listings and a contact form for inquiries.",
        techStack: ["HTML", "CSS"],
      },
      {
      ...
      },
      {
        name: "Weather App",
        description:
          "A real-time weather forecasting app built while completing the 'Modern JavaScript From The Beginning 2.0' course by Traversy Media. Displays temperature, humidity, and conditions using the OpenWeatherMap API, with a clean and responsive UI.",
    ...
    certifications: [
      ...
      "Modern JavaScript From The Beginning 2.0 – Traversy Media (May 2025)",
    ],
